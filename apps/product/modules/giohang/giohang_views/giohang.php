                                    ...
                                    <table style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product_quantity"><input min="0" max="100" id="soluong<?php echo $pro['MaG']?>" value="<?php echo $pro['soluong']?>" type="number" onChange="changeQuantity(<?php echo $pro['MaG']; ?>)"></td>
